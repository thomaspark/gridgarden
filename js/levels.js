var levels = [
  ...
  },
  {
    ...
    instructions: {
      ...
      'es': '<p>En lugar de definir un elemento en la cuadrícula basado en la posicione inicial y final, puedes definirlo basado en la longitud de columnas deseada usando la palabra clave <code>span</code>. Ten presente que <code>span</code> solo funciona con valores positivos.</p><p>Por ejemplo, riega las zanahorias usando <code>grid-column-end: span 2;</code>.</p>',
    },
    board: 'c',
