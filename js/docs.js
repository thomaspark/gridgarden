var docs = {
  'grid-area': {
    ...
    'ro': '<p>Specifică poziția și mărimea unui element al grilei în grilă.</p><p><code>&lt;grid-row-start&gt; / &lt;grid-column-start&gt; / &lt;grid-row-end&gt; / &lt;grid-column-end&gt;</code></p>',
  ...
  'grid-column': {
    ...
    'ro': '<p>Specifică poziția unui element al grilei în coloanele grilei.</p><p><code>&lt;grid-column-start&gt; / &lt;grid-column-end&gt;</code></p>',
  ...
  'grid-column-end': {
    ...
    'ro': '<p>Specifică poziția de sfârșit a unui element al grilei în coloanele grilei.</p><p><code>&lt;integer&gt;</code> <code>span &lt;integer&gt;</code></p>',
  ...
  'grid-column-start': {
    ...
    'ro': '<p>Specifică poziția de început a unui element al grilei în coloanele grilei.</p><p><code>&lt;integer&gt;</code> <code>span &lt;integer&gt;</code></p>',
  ...
  'grid-row': {
    ...
    'ro': '<p>Specifică poziția unui element al grilei în rândurile grilei.</p><p><code>&lt;grid-row-start&gt; / &lt;grid-row-end&gt;</code></p>',
  ...
  'grid-row-end': {
    ...
    'ro': '<p>Specifică poziția de sfârșit a unui element al grilei în rândurile grilei./p><p><code>&lt;integer&gt;</code> <code>span &lt;integer&gt;</code></p>',
  ...
  'grid-row-start': {
    ...
    'ro': '<p>Specifică poziția de început a unui element al grilei în rândurile grilei.</p><p><code>&lt;integer&gt;</code> <code>span &lt;integer&gt;</code></p>',
  ...
  'grid-template': {
    ...
    'ro': '<p>Specifică mărimea și numele rândurilor și coloanelor grilei.</p><p><code>&lt;grid-template-rows&gt; / &lt;grid-template-columns&gt;</code></p>',
  ...
  'grid-template-areas': {
    ...
    'ro': '<p>Specifică zonele numite ale grilei.</p><p><code>&lt;grid-name&gt;</code></p>',
  ...
  'grid-template-columns': {
    ...
    'ro': '<p>Specifică mărimea și numele coloanelor grilei.</p><p><code>&lt;length&gt;</code> <code>&lt;percentage&gt;</code> <code>&lt;flex&gt;</code> <code>max-content</code> <code>min-content</code> <code>minmax(min, max)</code></p>',
  ...
  'grid-template-rows': {
    ...
    'ro': '<p>Specifică mărimea și numele rândurilor grilei.</p><p><code>&lt;length&gt;</code> <code>&lt;percentage&gt;</code> <code>&lt;flex&gt;</code> <code>max-content</code> <code>min-content</code> <code>minmax(min, max)</code></p>',
  ...
  'order': {
    ...
    'ro': '<p>Specifică ordinea elementului în grilă.</p><p><code>&lt;integer&gt;</code></p>',
