var docs = {
  'grid-area': {
    ...
    'bn': '<p>grid এর মধ্যে একটি grid item এর অবস্থান এবং আকার নির্দিষ্ট করে।</p><p><code>&lt;grid-row-start&gt; / &lt;grid-column-start&gt; / &lt;grid-row-end&gt; / &lt;grid-column-end&gt;</code></p>',
  ...
  'grid-column': {
    ...
    'bn': '<p>grid কলামগুলির মধ্যে একটি grid item এর অবস্থান নির্দিষ্ট করে।</p><p><code>&lt;grid-column-start&gt; / &lt;grid-column-end&gt;</code></p>',
  ...
  'grid-column-end': {
    ...
    'bn': '<p>grid column এর মধ্যে একটি grid item এর শেষের অবস্থান নির্দিষ্ট করে।</p><p><code>&lt;integer&gt;</code> <code>span &lt;integer&gt;</code></p>',
  ...
  'grid-column-start': {
    ...
    'bn': '<p>grid column গুলোর মধ্যে একটি grid item এর শুরুর অবস্থান নির্দিষ্ট করে।</p><p><code>&lt;integer&gt;</code> <code>span &lt;integer&gt;</code></p>',
  ...
  'grid-row': {
    ...
    'bn': '<p>grid row গুলোর মধ্যে একটি grid item এর অবস্থান নির্দিষ্ট করে৷</p><p><code>&lt;grid-row-start&gt; / &lt;grid-row-end&gt;</code></p>',
  ...
  'grid-row-end': {
    ...
    'bn': '<p>grid row গুলির মধ্যে একটি grid item এর শেষ অবস্থান নির্দিষ্ট করে।</p><p><code>&lt;integer&gt;</code> <code>span &lt;integer&gt;</code></p>',
  ...
  'grid-row-start': {
    ...
    'bn': '<p>grid row গুলির মধ্যে একটি grid item এর শুরুর অবস্থান নির্দিষ্ট করে।</p><p><code>&lt;integer&gt;</code> <code>span &lt;integer&gt;</code></p>',
  ...
  'grid-template': {
    ...
    'bn': '<p>grid এর row এবং column এর আকার নির্দিষ্ট করে।</p><p><code>&lt;grid-template-rows&gt; / &lt;grid-template-columns&gt;</code></p>',
  ...
  'grid-template-areas': {
    ...
    'bn': '<p>নামযুক্ত grid এলাকাগুলি নির্দিষ্ট করে।</p><p><code>&lt;grid-name&gt;</code></p>',
  ...
  'grid-template-columns': {
    ...
    'bn': '<p>grid column গুলোর নাম এবং আকার নির্দিষ্ট  করে।</p><p><code>&lt;length&gt;</code> <code>&lt;percentage&gt;</code> <code>&lt;flex&gt;</code> <code>max-content</code> <code>min-content</code> <code>minmax(min, max)</code></p>',
  ...
  'order': {
    ...
    'bn': '<p>grid item গুলোর ক্রম নির্দিষ্ট করে।</p><p><code>&lt;integer&gt;</code></p>',
